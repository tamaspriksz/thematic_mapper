...
class FunctionsDownload:

    def __init__(self, telep):
        self.telep = telep



    def wikidownload_telep(self):
        """
...
# class Mapper(FunctionsDownload):
#
#     def __init__(self):
#         super().__init__(self)
#
...
def telep_start_mapper(telep, telep_to_map, position):
    ...
    # self.telep = telep
    # self.telep_to_map = telep_to_map
    # self.position = position

    out = []
    telep_list = list(telep['TELNEV'])
#    telep_list = list(telep)
